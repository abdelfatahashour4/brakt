        ...
        <div className="container">
          <div className="container-about">
            ...
            <p>
              ...
              to happen. Our application is{" "}
              <Link to="/" aria-label="home page open source">
                open source
              </Link>
              ,meaning you can inspect every little detail of the code, or chip
              in yourself! We are working to make our platform available for
              anyone to stand up similar communities in any niche or passion. We
              believe in transparency and adding value to the ecosystem. We hope
              you poke around and like what you see!
            </p>
